...
config = {
    ...
    u'solr_heatmap.tile_layer.url':
        u'http://{s}.tiles.mapbox.com/v4/mapbox.streets/{z}/{x}/{y}@2x.png?access_token'
        u'=pk.eyJ1IjoibmhtIiwiYSI6ImNpcjU5a3VuNDAwMDNpYm5vY251MW5oNTIifQ.'
        u'JuGQ2xZ66FKOAOhYl2HdWQ',
