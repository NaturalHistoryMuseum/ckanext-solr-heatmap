...
class SolrHeatmapPlugin(SingletonPlugin):
    '''Solr Heatmap plugin'''
    ...
    def update_config(self, config):
        ...
        toolkit.add_resource(u'theme/public', u'ckanext-solr-heatmap')
